class Product:
    """Class is a facade for the product API response.

    It is used to extract the information needed for the application.
    """
    ...
    def __init__(self, api_req):
        ...
        self.price = p["buybox_winner"][
            "price"
        ]  # Price is not clear which one is it, double check
